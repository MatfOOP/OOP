# Начин реализације курса -- Објектно-оријентисано програмирање (М, П, С, Р, Л) @ Математички факултет
...
- 65 поена практични испит

  - Праг за излазак на усмени испит је 30 поена

- 10 додатних поена

  - Додатни поени се могу освојити активношћу на часовима вежби. Додатни поени се додају на поене са практичног испита искључиво уколико је практични испит положен

- 35 поена усмени испит
