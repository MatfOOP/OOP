...
![фотографија Гослинг](slike/slika-gosling.jpg){: style="float:right; padding:16px"}
...
1. Да би се остварио захтев **1** (једноставан, објектно оријентисан, фамилијаран), одлучено је да:
...
2. Да би се остварио захтев **2** (робустан и сигуран), одлучено је да:
