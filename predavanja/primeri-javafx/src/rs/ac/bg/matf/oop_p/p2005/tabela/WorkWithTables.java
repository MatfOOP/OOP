package rs.ac.bg.matf.oop_p.p2005.tabela;
 ...
 * @author cdea
 */
public class WorkWithTables extends Application
{
	/**
	 * @param args
	...
	private ObservableList<Person> getPeople()
	{
		...
		magneto.employeesProperty().add(
				new Person("Mystique", "Raven", "Darkhölme"));
		magneto.employeesProperty()
				.add(new Person("Sabretooth", "Victor", "Creed"));
