...
package rs.math.oop1.zd.p040401.primitivniTipovi.z03.realniZapisKonstanti;
...
public class RealniiTip {
   ...
   public static void main(String[] args) {
	   ...
	   double d1 = 23.57;
	   //za jednostruku preciznost se mora eksplicitno navesti kvalifikator f na kraju broja
	   float f1 = 23.57f;
	   float f2 = 23.57F; //može i veliko slovo F
	   double d2 = .454; //celobrojni deo se može izostaviti, i tada se podrazumeva da iznosti 0
	   double d3 = 2.2e-5; //broj koji iznosi 2.2 x 10^(-5)
	   float f3 = 2e5f; //broj koji iznosi 2 x 10^5 = 200000.0 u jednostrukoj preciznosti
	   System.out.println(f3);
	   float f4 = 35535353.000003f;
	   System.out.println(f4); //ispisuje 3.5535352E7, jer nema dovoljnu preciznost da zapamti ceo broj
