...
public class PokretanjeZamenaParametaraPriPozivu {
   ...
   static void utrostruciPlatu(Profesor x) {
      System.out
               .println("\tUnutar metoda, na pocetku izvrsavanja: x.plata="
                        + x.plata);
      x.povecajPlatu(200);
      System.out
               .println("\tUnutar metoda, na kraju izvrsavanja:   x.plata="
                        + x.plata);
   }

   static void razmeni(Profesor x, Profesor y) {
      System.out
               .println("\tUnutar metoda, na pocetku izvrsavanja: x="
                        + x.imePrezime);
      System.out
               .println("\tUnutar metoda, na pocetku izvrsavanja: y="
                        + y.imePrezime);
      Profesor temp = x;
      x = y;
      y = temp;
      System.out
               .println("\tUnutar metoda, na kraju izvrsavanja:   x="
                        + x.imePrezime);
      System.out
               .println("\tUnutar metoda, na kraju izvrsavanja:   y="
                        + y.imePrezime);
   }
   ...
   static Profesor kreiraj(String ime, String prezime,
            double plata) {
      System.out
               .println("\tUnutar metoda, na pocetku izvrsavanja: ime="
                        + ime);
      System.out
               .println("\tUnutar metoda, na pocetku izvrsavanja: prezime="
                        + prezime);
      System.out
               .println("\tUnutar metoda, na pocetku izvrsavanja: plata="
                        + plata);
      Profesor rez = new Profesor();
      rez.init(ime + " " + prezime, plata);
      System.out
               .println("\tUnutar metoda, na kraju izvrsavanja:   rez="
                        + rez.imePrezime);
      return rez;
   }
   ...
   public static void main(String[] args) {
      ...
      System.out.println(
               "Pre poziva:   plata=" + pera.plata);
      utrostruciPlatu(pera);
      System.out.println(
               "Posle poziva: plata=" + pera.plata);

      // Pokretanje 2: Metod ne moze objektnom parametru trajno pridruziti neki drugi objekat
      System.out.println(
      ...
      // Pokretanje 3: Metod moze poljima objektnog parametra trajno pridruziti neku drugu vrednost
      System.out.println(
               "\nPokretanjeiranje metoda razmeni():");
      ...
      System.out
               .println("Pre poziva:   profIme=" + profIme);
      System.out.println(
               "Pre poziva:   profPrezime=" + profPrezime);
      System.out.println(
               "Pre poziva:   profPlata=" + profPlata);
      Profesor profa = kreiraj(profIme, profPrezime,
               profPlata);
      System.out.println(
               "Posle poziva: profa=" + profa.imePrezime);
