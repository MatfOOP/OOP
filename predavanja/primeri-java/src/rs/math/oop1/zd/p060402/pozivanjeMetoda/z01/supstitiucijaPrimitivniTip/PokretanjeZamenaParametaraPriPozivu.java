...
package rs.math.oop1.zd.p060402.pozivanjeMetoda.z01.supstitiucijaPrimitivniTip;
...
public class PokretanjeZamenaParametaraPriPozivu {
   ...
   public static void main(String[] args) {
      ...
      double procenat = 10;
      System.out.println(
               "Pre poziva:   procenat=" + procenat);
      utrostruci(procenat);
      System.out.println(
               "Posle poziva: procenat=" + procenat);
      ...
      double procenat1 = 10;
      System.out.println(
               "Pre poziva:   procenat1=" + procenat1);
      procenat1 = utrostruci1(procenat1);
      System.out.println(
               "Posle poziva: procenat1=" + procenat1);
