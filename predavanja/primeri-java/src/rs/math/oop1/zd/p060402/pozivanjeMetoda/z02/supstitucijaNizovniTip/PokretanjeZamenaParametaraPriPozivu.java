...
package rs.math.oop1.zd.p060402.pozivanjeMetoda.z02.supstitucijaNizovniTip;

public class PokretanjeZamenaParametaraPriPozivu {

   static String prikazi(double[] x) {
      String rezultat = "";
      for (double broj : x)
         rezultat += " " + broj;
      return rezultat;
   ...
   static void utrostruciSve(double[] niz) {
      System.out
               .println("\tUnutar metoda, na pocetku izvrsavanja: niz="
                        + prikazi(niz));
      for (int i = 0; i < niz.length; i++)
         niz[i] = 3 * niz[i];
      System.out
               .println("\tUnutar metoda, na kraju izvrsavanja:   niz="
                        + prikazi(niz));
   }
   ...
   public static void main(String[] args) {
      // Pokretanje 1: Metod moze da promeni neki od elemenata u parametru nizovnog tipa
      System.out.println(
               "\nPokretanjeiranje metoda utrostruciSve():");
      double[] brojevi =
      { 1.0, 2, 3, 4, 5 };
      System.out.println(
               "Pre poziva:   brojevi=" + prikazi(brojevi));
      utrostruciSve(brojevi);
      System.out.println(
               "Posle poziva: brojevi=" + prikazi(brojevi));
      
      // Pokretanje 2: Method ne moze nizovnom parametru trajno pridruziti neki drugi niz
      System.out.println(
               "\nPokretanjeiranje metoda praviNovi():");
      double[] brojevi1 =
      { 1.0, 2, 3, 4, 5 };
      System.out.println("Pre poziva:   brojevi1="
               + prikazi(brojevi1));
      praviNovi(brojevi1);
      System.out.println("Posle poziva: brojevi1="
               + prikazi(brojevi1));
      /*
      ...
      double[] brojevi2 =
      { 1.0, 2, 3, 4, 5 };
      System.out.println("Pre poziva:   brojevi2="
               + prikazi(brojevi2));
      brojevi2 = praviNovi1(brojevi2);
      System.out.println("Posle poziva: brojevi2="
               + prikazi(brojevi2));
*/
   }
}
