...
package rs.math.oop1.zd.p060801.modifikatoriPristupa.z01.fakultet;

public class Student {
   private String ime;
   private String prezime;
   java.time.LocalDate rodjen;
   private String smer;
   ...
   public void init(String studIme, String studPrezime,
   ...
   public byte brojPolozenihIspita() {
   ...
   public static Student ucitaj(java.util.Scanner sc,
