package rs.math.oop1.zd.p170304.filterMapReduce.z04.folksFilterPrebroj;

import java.util.function.Predicate;
import java.util.function.Function;
import static rs.math.oop1.zd.p170304.filterMapReduce.z04.folksFilterPrebroj.Folks.friends;
	...
	{
		{
			...
			final long countFriendsStartN = friends.stream().filter( startsWithN )
					.count();
			final long countFriendsStartB = friends.stream().filter( startsWithB )
					.count();
