package rs.math.oop1.zd.p170304.filterMapReduce.z08.assetsSumiranje;

import java.util.Arrays;
import java.util.List;
import rs.math.oop1.zd.p170304.filterMapReduce.z08.assetsSumiranje.Asset.AssetType;
...
public class AssetUtil
{
	...
	public static int totalBondValues( final List<Asset> assets )
	{
		return assets.stream()
				.mapToInt(
						asset -> asset.getType() == AssetType.BOND ? asset.getValue() : 0 )
				.sum();
	}
	...
	public static int totalStockValues( final List<Asset> assets )
	{
		return assets.stream()
				.mapToInt(
						asset -> asset.getType() == AssetType.STOCK ? asset.getValue() : 0 )
				.sum();
	}
