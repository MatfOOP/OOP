...
package rs.math.oop1.zd.p060403.metodiPrimerkaKlasni.z01.fakultet;
...
class Student {
   ...
   static Student ucitaj(java.util.Scanner sc, boolean prikaziPitanje) {
      ...
      {
         if( prikaziPitanje)
            System.out.print("Ocena iz predmeta '" + Predmet.getNaziv(i) + "': ");
         ocene[i] = sc.nextInt();
      }  
