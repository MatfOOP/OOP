...
5. Рад са корисничким објектним типовима испорученим уз ЈДК-а
    ...
    1. Приступ систему, класа `System`
        ...
        1. Приказ текста на излазни ток, објекат `System.out`

        1. Приказ текста на ток за грешке, објекат `System.err`

        1. Мерење протеклог времена, метод `System.nanoTime()`

        1. Приступ објекту за сакупљање отпадака `System.gc`
