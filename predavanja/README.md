...
3. [Карактеристике програмског језика Јава](tekstovi/Karakteristike-jezika-Java.md)

    1. [Историјат и развој програмског језика и окружења Јава](tekstovi/Karakteristike-jezika-Java.md#настанак-и-развој)
    ...
    1. [Захтеви постављени за програмски језик и окружење Јава](tekstovi/Karakteristike-jezika-Java.md#захтеви-за-јаву)
...
4. [Структура Јава програма](/prezentacije/OOP04-Elementarne konstrukcije u Javi.pdf){:target="_blank"}
    ...
    1. Наредбе
        ...
        1. Улазна тачка програма, `static` метода `main`
...
5. Рад са корисничким објектним типовима испорученим уз ЈДК-а
    ...
    1. Приступ систему, класа `System`
        ...
        1. Приказ текста на конзоли, објекат `System.out`

        1. Приступ елементима Јава окружења 

            1. Објекат `System.gc`

            1. Метод `System.lineSeparator()`
    ...
    1. Класе-омотачи за примитивне типове
    ...
    1. Класе за рад са датумима и временима

        1. Класа за рад са датумима `Date`

        1. Мерење протеклог времена

    1. Скенери, класа `Scanner`
...
6. [Низови у Јави](/prezentacije/OOP08-Nizovi u Javi.pdf){:target="_blank"}
    ...
    1. Аргументи функција променљиве дужине
