...
public class Dugme extends Application
{
  ...
  public void start(Stage primarnaScena) throws Exception
  {
    ...
    primarnaScena.setTitle("Dugme 2");
  ...
  {
    Button dugme = ButtonBuilder.create().layoutX(250).layoutY(20)
        .text("Ispisi").onAction(new EventHandler<ActionEvent>()
        {
  ...
  {
    Pane panel = PaneBuilder.create().layoutX(0).layoutY(120).prefHeight(280)
        .prefWidth(600).build();
    return panel;
  }
