...
У наступајућем периоду (почев од понедељка 16.03.2020. па до појаве новог обавештења на овом месту) **предавања** из предмета **Објектно орјенитисано програмирање** ће бити реализована помоћу система за учење на даљину.
